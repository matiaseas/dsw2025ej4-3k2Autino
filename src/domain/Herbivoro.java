...
public class Herbivoro extends Mamifero{
    ...
    public Herbivoro(int edad, double peso, Especie especie, Sector sector, double valorFijo, Pais paisOrigen) throws InvalidPropertiesFormatException {
        super(TipoAlimentacion.HERBIVORO, edad, peso, especie, sector, paisOrigen);
